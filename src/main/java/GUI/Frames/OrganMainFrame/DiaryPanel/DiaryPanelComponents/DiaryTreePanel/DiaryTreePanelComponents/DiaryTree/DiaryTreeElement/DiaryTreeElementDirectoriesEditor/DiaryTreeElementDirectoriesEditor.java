...
public class DiaryTreeElementDirectoriesEditor implements ITreeElementDirectoriesEditor{
    ...
    public void createElementDirectories(IDiaryTreeElement diaryTreeElement) {
        //Update directory and noteFile. Create new directory with new name
        /*IDiaryTreeElement parentElement = (IDiaryTreeElement)diaryTreeElement.getParent();
        DirectoryFile newDirectory = new DirectoryFile(parentElement.getDirectoryFile().getFile(), diaryTreeElement.getUserObject().toString(), true);
        NoteFile newNoteFile = new NoteFile(newDirectory.getFile(), diaryTreeElement.getUserObject().toString(), filesFormat);

        directory = newDirectory;
        noteFile = newNoteFile;*/
        renameElement(diaryTreeElement);
    }
